...
r = redis.Redis(host="47.94.196.111",password="1111", port=6379, db=0)
...
def setUseStart(url,ip):
    r.hset("useStartIp",url+"_"+ip,ip)

def isExistsStartIP(url,ip):
    return  r.hexists("useStartIp",url+"_"+ip)
